...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		MundoWumpus mundoWumpus = new MundoWumpusBuilder()
				.quantidadeSalasPorLado(quantidadeSalasPorLado)
				.quantidadeDeWumpus(quantidadeDeWumpus)
				.quantidadeCova(quantidadeCova)
				.quantidadeFlecha(quantidadeFlecha)
		...
		while (resultado == null || !resultado.gameOver()) {
			...
			if (direcao.equals(Direcao.MOVIMENTO_INVALIDO)) {
